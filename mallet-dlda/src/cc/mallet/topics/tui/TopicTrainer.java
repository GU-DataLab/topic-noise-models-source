	...
	public static void main (String[] args) throws java.io.IOException {
		...
		if (inputModelFilename.value != null) {
            ...
            if (alphaArrayInFile != null && alphaArrayInFile.value != null) {
                ...
                topicModel = new ParallelTopicModel (numTopics.value, alphaArray, beta.value, initialTopicWordDist);
            } else {

                topicModel = new ParallelTopicModel (numTopics.value, alpha.value, beta.value, initialTopicWordDist);
            }
		}
