...
public class ParallelTopicModel implements Serializable {
	...
	public ParallelTopicModel (int numberOfTopics, double alphaSum, double beta,
		...
		this (newLabelAlphabet (numberOfTopics), alphaSum, beta, initialTopicWordDist);
	}

    public ParallelTopicModel (int numberOfTopics, double[] alpha, double beta,
                               HashMap<String, Integer[]> initialTopicWordDist) {
        this (newLabelAlphabet (numberOfTopics), alpha, beta, initialTopicWordDist);
    }
	...
	public ParallelTopicModel (LabelAlphabet topicAlphabet, double alphaSum, double beta,
		...
		logger.info("Mallet D-LDA: " + numTopics + " topics, " + topicBits + " topic bits, " +
					Integer.toBinaryString(topicMask) + " topic mask");
	}

    public ParallelTopicModel (LabelAlphabet topicAlphabet, double[] alpha, double beta,
	                           HashMap<String, Integer[]> initialTopicWordDist) {
